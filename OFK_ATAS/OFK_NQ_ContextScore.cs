// ============================================================================
//  OFK_NQ_ContextScore.cs — ATAS
//  Score directionnel contextuel scalping NQ E-mini.
//
//  Score = -100 à +100 :
...
//
//  Lit le même JSON que OFK_NQ_GEX_Levels via GexLoader (shared).
// ============================================================================
using System;
...
namespace OFK_GEX
{
    [DisplayName("OFK NQ Context Score")]
    [Category("OFK Suite")]
    [Description("Score directionnel contextuel (GEX + VIX + macro). Lit full_levels_NQ.json.")]
    public class OFK_NQ_ContextScore : Indicator
    {
        #region Source
        ...
        public OFK_NQ_ContextScore() : base(true)
        {
        ...
        public override string ToString() => "OFK NQ Context Score";
    }
}
