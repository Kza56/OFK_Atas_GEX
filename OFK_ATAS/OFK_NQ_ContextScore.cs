...
//  Contextual directional score for NQ E-mini scalping.
//
//  Score = -100 to +100:
...
//
//  Reads the same JSON as OFK_NQ_GEX_Levels via GexLoader (shared).
// ============================================================================
using System;
...
namespace OFK_GEX
{
    ...
    [Category("OFK Suite")]
    [Description("Contextual directional score (GEX + VIX + macro). Reads full_levels_NQ.json.")]
